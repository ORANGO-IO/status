...
def run_playwright_script(task_config):
    context = {}
        ...
        for step in task_config:
            ...
            try:
                if action == "goto":
                    ...
                    print(
                        f"🔍 Buscando link com 'Leia Mais' e aria-label contendo: {versao}"
                    )
                ...
                return "error", f"{action} falhou: {str(e)}"

        browser.close()
        print("✅ Execução finalizada")

    return "success", extracted_result or json.dumps(context)
